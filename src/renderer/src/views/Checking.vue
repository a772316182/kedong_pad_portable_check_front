  ...
  <q-layout view="lHh Lpr lFf" class="page-background">
    ...
    <div class="top-bar row items-center justify-between q-px-md">
      ...
      <div>
        ...
        <q-btn flat dense no-caps class="header-action-btn" icon="o_tune" label="筛选" @click="isFilterDrawerOpen = true"/>
        <q-btn flat dense no-caps class="header-action-btn" icon="o_bar_chart" label="查看统计图"/>
        <span class="q-ml-md">当前电量: 14% <q-icon name="o_battery_3_bar"/></span>
      </div>
    </div>
    <!-- “正在核查 标题” -->
      ...
      <q-card style="width: 500px;">
        ...
        <q-card-section class="row items-center justify-center q-gutter-xl q-py-xl">
          <q-card class="export-option-card" flat bordered clickable v-ripple @click="handleExportAll">
            <q-card-section class="text-center"><q-icon name="o_article" size="4em" color="primary"/><div class="text-subtitle1 q-mt-sm">导出全部</div></q-card-section>
          </q-card>
          <q-card class="export-option-card" flat bordered clickable v-ripple>
            <q-card-section class="text-center"><q-icon name="o_checklist" size="4em" color="primary"/><div class="text-subtitle1 q-mt-sm">导出选中</div></q-card-section>
          </q-card>
        </q-card-section>
